...
(function() {
  ...
  Lexer = (function() {
    var BOOLEAN, DBLSTRING, LITERAL, MATH, MATH_MULTI, NUMBER, PARAMETER, SEPARATOR, SQL_BETWEENS, SQL_CONDITIONALS, SQL_FUNCTIONS, SQL_OPERATORS, SQL_SORT_ORDERS, STAR, STRING, SUB_SELECT_OP, SUB_SELECT_UNARY_OP, VARIABLE, WHITESPACE;
    ...
    Lexer.prototype.variableToken = function() {
      if (this.variableTokens.length > 0) {
        return this.tokenizeFromList('VARIABLE', this.variableTokens);
      }
    };
...
if (typeof module !== 'undefined' && require.main === module) {
  ...
  // Generated by CoffeeScript 1.8.0
(function() {
  var ArgumentListValue, BetweenOp, Field, FunctionValue, Group, Having, Join, Limit, ListValue, LiteralValue, Offset, Op, Order, OrderArgument, ParameterValue, Select, Star, StringValue, SubSelect, Table, UnaryOp, Union, VariableValue, Where, indent;
  ...
  exports.VariableValue = VariableValue = (function() {
    function VariableValue(value, openingDelimiter, closingDelimiter) {
      this.value = value;
      this.openingDelimiter = openingDelimiter != null ? openingDelimiter : "{";
    ...
    VariableValue.prototype.toString = function() {
      return "" + this.openingDelimiter + this.value + this.closingDelimiter;
    };
