...
(function() {
  ...
  grammar = {
    ...
    Table: [
      ...
      }), o('Pattern WINDOW WINDOW_FUNCTION LEFT_PAREN Number RIGHT_PAREN', function() {
        return $1.setWindow($2, $3, $5);
      })
    ],
    Pattern: [
      o('PATTERN LEFT_SQUARE_BRACKET PatternClauses RIGHT_SQUARE_BRACKET', function() {
        return new Pattern($3);
      })
    ],
    PatternClauses: [
      o('PatternClauses RIGHT_ROCKET PatternClause', function() {
        return $1.concat($3);
      }), o('PatternClause', function() {
        return [$1];
      })
    ],
    PatternClause: [
      o('LITERAL EQUAL LITERAL LEFT_PAREN Expression RIGHT_PAREN', function() {
        return new PatternConstraint($1, $3, $5);
      }), o('LITERAL EQUAL LITERAL', function() {
        return new PatternConstraint($1, $3);
      })
    ],
    Unions: [
      o('Union', function() {
  ...
  operators = [['left', 'Op'], ['left', 'MATH_MULTI'], ['left', 'MATH'], ['left', 'EQUAL'], ['left', 'OPERATOR'], ['left', 'CONDITIONAL']];
